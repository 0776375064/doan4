...
public class ManagerComments extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        if(todo.equals("list")){
            List<Comment> list = commentFacade.findAll();
            
            request.setAttribute("list",list );
            RequestDispatcher requestDispatcher = request.getRequestDispatcher("admin/comments/list.jsp");
