        ...
        <div class="w3-container">
            <div class="w3-row">
                <div class="w3-col container" style="width:50%">
                    <h2 class="">
                        <img height="50px" src="https://img.icons8.com/fluency/96/000000/change-user-male.png"/>
                        <b>Manage Recharge</b>
                    </h2>
                </div>
                <div class="w3-col container" style="width:50%">
            ...
            {
                $.ajax({
                    url: $("#url").val() + "/Money?date=details",
                    dataType: 'text',
                    type: 'get',
                    cache: false,
            ...
            $('#reportrange').daterangepicker({
                ...
                $.ajax({
                    url: $("#url").val() + "/Money?date=detailsdate",
                    dataType: 'text',
                    type: 'get',
                    cache: false,
                    data: {
            ...
            <div class="card form-group">
                <div class="card-body">
                    <div class="w3-bar  ">
                        <button class="w3-bar-item w3-button tablink w3-red" onclick="openCity(event, 'London')"> Recharge</button>
